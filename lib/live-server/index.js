...
function staticServer(root, extraInjectCandidates,onTagMissedCallback) {
	var isFile = false;
...
LiveServer.start = function (options, callback) {
	...
	/*new*/
	var customHtmlTagPrefer = options.customHtmlTagPrefer || [];
	var disableGlobbing = options.disableGlobbing || false;
	var onTagMissedCallback = options.onTagMissedCallback || null;
	var staticServerHandler = staticServer(root, customHtmlTagPrefer, onTagMissedCallback);
