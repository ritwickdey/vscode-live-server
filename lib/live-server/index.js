	...
	LiveServer.liveEditing = function (doc, content) {
		if (blockLiveEditing) {
			...
			clients.forEach(function (ws) {
				...
				const wsFileIndex = _.findIndex(wsFile, function(o) { return o.match('.html') })
				const changePathFileIndex = _.findIndex(changePathFile, function(o) { return o.match('.html') })

				if (ws && (wsFile[wsFileIndex] === changePathFile[changePathFileIndex])) {
