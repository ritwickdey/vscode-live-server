...
LiveServer.start = function (options, callback) {
	...
	LiveServer.onTextChange = function (doc, content) {
		if (onTextChangeStop) {
			...
			content = content.replace(new RegExp(injectTag, "i"), GET_INJECTED_CODE() + injectTag);
